...
*/
	...
	//读取文件内容
	//offset偏移地址,即起始读取位置；readLength,读取长度
	public static function readFile(offset:Number,readLength:Number):String
	{
		return ExternalInterface.call("read_file",offset,readLength);
	}
	//写字符串到文件
	//offset偏移地址，起始写位置；writeLength，所写字符串长度；writeString，所写字符串
	public static function writeFile(offset:Number,writeLength:Number,writeString:String)
	{
		ExternalInterface.call("write_file",offset,writeLength,writeString);
	}
	/**
