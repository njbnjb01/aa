...
*/
	...
	public static var VE_RATIO_LETTER_BOX = 2;	///< display ratio: full screen with no distortion
	public static var VE_RATIO_FULL_SCREEN = 3;	///< display ratio: full screen with distortion
	public static var VE_RATIO_ACTUAL_SIZE = 4;	///< display ratio: original size
