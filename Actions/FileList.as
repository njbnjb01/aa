...
*/
	...
	public static var FL_MODE_DIR_BORWSE_ALL		=1; 		 		///<all the file and dir will be list,even if the dir is empty
	public static var FL_MODE_DIR_BORWSE_VALID	=2; 				///<only the valid file and the directory which include the vaild file will be listed
